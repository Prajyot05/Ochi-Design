...
function Footer() {
  return (
    <div className='w-full h-screen p-20 flex gap-5 font-["Founders_Grotesk_X-Condensed"]'>
        <div className='w-1/2 h-full flex flex-col justify-between'>
            <div className='heading'>
                <h1 className='text-9xl uppercase leading-none -mb-10 font-bold'>Eye-</h1>
                <h1 className='text-9xl uppercase leading-none -mb-10 font-bold'>Opening</h1>
            </div>
        ...
        <div className='w-1/2'>
            <h1 className='text-9xl uppercase leading-none font-bold'>Presentations</h1>
            <div className='flex gap-32'>
                <div className='dets font-["Neue_Montreal"]'>
                    <a className='block text-xl font-light mt-20'>Facebook</a>
                    <a className='block text-xl font-light mt-20'>Instagram</a>
                    <a className='block text-xl font-light mt-20'>Twitter</a>
                </div>
                <div className='dets font-["Neue_Montreal"]'>
                    <a className='block text-xl font-light mt-20'>Facebook</a>
                    <a className='block text-xl font-light mt-20'>Instagram</a>
